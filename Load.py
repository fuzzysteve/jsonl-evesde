...
graphics.import_graphic_material_sets(connection, metadata, sourcePath, language)
...
characterTitles.import_character_titles(connection, metadata, sourcePath, language)
missions.import_archetypes(connection, metadata, sourcePath, language)
missions.import_dungeons(connection, metadata, sourcePath, language)
missions.import_missions(connection, metadata, sourcePath, language)
missions.import_epic_arcs(connection, metadata, sourcePath, language)
shiptree.import_ship_tree_elements(connection, metadata, sourcePath, language)
shiptree.import_ship_tree_factions(connection, metadata, sourcePath, language)
shiptree.import_ship_tree_groups(connection, metadata, sourcePath, language)
shiptree.import_type_elements(connection, metadata, sourcePath, language)
military.import_military_campaigns(connection, metadata, sourcePath, language)
military.import_military_campaign_objectives(connection, metadata, sourcePath, language)
military.import_mercenary_tactical_operations(connection, metadata, sourcePath, language)
military.import_sovereignty_upgrades(connection, metadata, sourcePath, language)
skinr.import_skinr_component_categories(connection, metadata, sourcePath, language)
skinr.import_skinr_component_rarities(connection, metadata, sourcePath, language)
skinr.import_skinr_component_point_values(connection, metadata, sourcePath, language)
skinr.import_skinr_components(connection, metadata, sourcePath, language)
skinr.import_skinr_slot_categories(connection, metadata, sourcePath, language)
skinr.import_skinr_slot_names(connection, metadata, sourcePath, language)
skinr.import_skinr_slots(connection, metadata, sourcePath, language)
skinr.import_skinr_slot_configurations(connection, metadata, sourcePath, language)
skinr.import_skinr_tier_thresholds(connection, metadata, sourcePath, language)
compressible.import_compressible_types(connection, metadata, sourcePath, language)
freelance.import_freelance_job_schemas(connection, metadata, sourcePath, language)
translationlanguages.import_translation_languages(connection, metadata, sourcePath, language)
contraband.import_contraband_types(connection, metadata, sourcePath, language)
controltower.import_control_tower_resources(connection, metadata, sourcePath, language)
